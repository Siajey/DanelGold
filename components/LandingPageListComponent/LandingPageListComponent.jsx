...
function LandingPageListComponent() {
  return (
    <div id="LandingPageListComponent-fully-container" className="mt-5">
      <div className="flex justify-start lg:justify-center overflow-x-scroll items-center">
        <table className="w-[90vw] table-content">
          <thead className="border-b-2">
            <tr>
              <th className="p-2">
                <p className="font-medium text-start text-[15px] text-gray-700 dark:text-white opacity-50 leading-[15px]">
                  Rank
                </p>
              </th>
              <th className="p-2">
              ...
              <th className="p-2">
                <p className="font-semibold text-start text-[15px] text-gray-700 dark:text-white opacity-70 leading-[15px]">
                  Floor price
                </p>
              </th>
              <th className="p-2">
            ...
            <tr>
              ...
              <td className="p-2">
                <div className="flex justify-start items-center w-[220px]">
                  ...
                  <p className="font-medium text-[15px] text-gray-700 dark:text-white leading-[20px] ml-5">
                    Gaming human
                  </p>
                </div>
              </td>
