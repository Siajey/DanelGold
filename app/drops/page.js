...
function page() {
  ...
  return (
    <div id="Drops-page-fully-container" className="">
      ...
      <div className="embla flex flex-row-reverse justify-between items-center px-3 lg:p-10">
      ...
      <div>
        <div className="grid grid-cols-1 place-items-center md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 mt-7">
