    ...
    <div id="What-Is-An-NFT-fully-container">
      ...
      <div className="flex justify-between items-center mt-10">
        <div className="flex justify-center items-center ml-5">
          ...
          <p className="font-semibold text-[30px] text-gray-700 dark:text-white leading-[36px] ml-7">
            Magazines
          </p>
        </div>
      ...
      <div className="w-[80vw] flex justify-end items-end mt-20">
        <p className="font-light text-[20px] text-gray-700 dark:text-white opacity-80">
          From the magazine
        </p>
      </div>
      ...
      <div className="flex justify-center items-center">
        ...
        <div className="flex  justify-items-start items-start mt-[40px] gap-[150px]">
          ...
          <div className=" mr-12 mb-10 mt-[100px]">
            <div className="flex justify-center items-center">
              <p className="font-bold text-[30px] text-gray-700 dark:text-white leading-[35px]">
                What is an NFT?
              </p>
            </div>

            <div className="w-[530px]">
              <p className="font-light text-[30px] text-gray-700 dark:text-white leading-[55px] opacity-70 mt-3">
            ...
            <div className="flex flex-col justify-end items-end mt-5 mr-5">
              <p className="font-bold text-[25px] text-gray-700 dark:text-white leading-[50px]">
              ...
              <div className="w-[250px] flex flex-col justify-start items-start mr-[62px]">
                <div className="flex justify-center items-center mt-2 mr-5">
                  <p className="font-normal text-[20px] text-gray-700 dark:text-white leading-[50px] opacity-80 mr-3">
                    Written by
                  </p>
                  <p className="font-bold text-[20px] text-gray-700 dark:text-white leading-[50px]">
                    Daniel grey
                  </p>
                </div>
                ...
                <div className="flex justify-center items-center mt-2">
                  <p className="font-normal text-[20px] text-gray-700 dark:text-white leading-[50px] opacity-80 ">
                    June 4, 2023
                  </p>
                </div>
              </div>
