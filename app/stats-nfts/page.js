      ...
      <div id="" className="flex flex-col">
        ...
        <div className="flex flex-row justify-evenly items-center mt-8">
          ...
          <div className="flex justify-center items-center">
            ...
            <div>
              <input
                className="relative flex justify-center items-center w-40 lg:w-[76vw] h-[40px] bg-[#878585] rounded-[10px] pl-8 placeholder:font-semibold placeholder:text-[12px] placeholder:text-[#000000]"
                style={{}}
                placeholder="Search by NFTS"
              />

              <div className="absolute top-[240px]  ml-3">
          ...
          {StatsNFTCardsData.map((card) => (
            <div className="">
              ...
              >
                ...
                <div className="mt-1">
                  <p className="font-semibold text-[20px] text-gray-700 dark:text-white leading-[25px]">
                    {card.NFTCardName}
                  </p>
                </div>
