...
import StatsCollectionsPageListComponent
    from '@/components/StatsCollectionsPageListComponent/StatsCollectionsPageListComponent'
            ...
            <div id='' className='flex flex-col'>
                ...
                <div className='flex flex-row-reverse justify-between items-center mt-10 mr-20 ml-5'>
                    ...
                    <div className='flex justify-center items-center gap-3'>
                        ...
                        <div
                            className='flex justify-center items-center w-[185px] h-[40px] bg-[#878585] rounded-[10px] gap-5'>
                            <button>
                            ...
                            <button>
                                <div
                                    className='flex justify-center items-center w-[40px] h-[30px] bg-[#FFFFFF] rounded-[10px]'>
                                    <p className='font-semibold text-[12px] text-[#000000] leading-[15px]'>
                                        30d
                                    </p>
                                </div>
